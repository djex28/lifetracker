<div style="width:auto; min-height:1000px; margin:0px; background-image: url('View/Templates/Images/IMG_9649.jpg'); background-size: cover; -webkit-background-size: cover;">
<div class='container'>
    <center>
        <div style='margin-top:50px; width:auto; max-width:500px; height:auto; background-color:#eee; background: rgba(204, 204, 204, 0.5);'><font color='red'><?php echo isset($_POST['error']) ? str_replace("+", " ", $_POST['error']) : null; ?></font></div>
     <div style='width:auto; height:auto; max-width:500px; text-align:left; background-color:#eee; background: rgba(204, 204, 204, 0.5); margin-top:10px; '>
